...
<h1 style="text-align: center;">发动机排量统计</h1>
...
<form id="f_export" action="${ctx}/statistics/enginetype/export" method="post" target="_blank">
    <input type="hidden" id="filename" name="filename" value="发动机排量统计"/>
...
<script type="text/javascript"
        src="${ctx}/static/js/app/statistics/enginetype.js?_=${.now?string('yyyyMMddHHmmss')}"></script>
</@override>
