...
<script type="text/javascript"
        src="${ctx}/static/js/app/statistics/areastatistics.js?_=${.now?string('yyyyMMddHHmmss')}"></script>
</@override>
